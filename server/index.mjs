...
function sysPrompt(s,kind,np){ const who=s.ai_name||'DJ',partner=s.user_name||'You'; const scene=kind==='book'?'reading together in a cozy room':'listening to music together in a cozy room'; const dj='\u4f60\u53ef\u4ee5\u63a7\u5236\u64ad\u653e\u5668\u3002\u5f53\u4f60\u60f3\u653e\u67d0\u9996\u6b4c/\u5207\u6b4c/\u6682\u505c/\u7ee7\u7eed\u65f6\uff0c\u5728\u56de\u590d\u7684\u6700\u540e\u5355\u72ec\u4e00\u884c\u8f93\u51fa\uff1a<<ACT>>{\"type\":\"play\",\"query\":\"\u6b4c\u540d \u6b4c\u624b\"}<<>>\uff08play \u9700\u8981 query\uff1b\u4e0b\u4e00\u9996\u7528 type:\"next\"\u3001\u4e0a\u4e00\u9996 \"prev\"\u3001\u6682\u505c \"pause\"\u3001\u7ee7\u7eed \"resume\"\uff0c\u8fd9\u4e9b\u4e0d\u9700\u8981 query\uff09\u3002\u60f3\u628a\u4e00\u9996\u6b4c\u63a8\u8350\u7ed9\u5bf9\u65b9\u4f46\u4e0d\u6253\u65ad\u5f53\u524d\u64ad\u653e\u65f6\uff0c\u5355\u72ec\u4e00\u884c\u8f93\u51fa\uff1a<<ACT>>{"type":"share","query":"\u6b4c\u540d \u6b4c\u624b"}<<>>\uff1b\u5206\u4eab\u5f53\u524d\u6b63\u5728\u653e\u7684\u8fd9\u9996\u7528 {"type":"share"}\uff08\u4e0d\u5e26 query\uff09\uff0c\u4f1a\u5728\u623f\u95f4\u91cc\u5f39\u51fa\u5206\u4eab\u5361\u7247\u3002\u6b63\u5e38\u804a\u5929\u65f6\u4e0d\u8981\u8f93\u51fa ACT\uff0c\u4e5f\u4e0d\u8981\u89e3\u91ca\u8fd9\u4e2a\u683c\u5f0f\u3002'; const nowLine=(np&&np.title)?('\u73b0\u5728\u6b63\u5728\u4e00\u8d77\u542c\u7684\u6b4c\u662f\u3010'+np.title+(np.artist?(' \u2014 '+np.artist):'')+'\u3011\uff0c\u81ea\u7136\u5730\u7ed3\u5408\u5b83\u6765\u56de\u5e94\u3002'):''; // 稳定前缀在前（persona/身份/DJ 指令），会变的"正在播"放最后 —— 中转的前缀缓存才能命中
 return [s.ai.persona,'Your name is '+who+'. You are with '+partner+', '+scene+'.','Reply in the same language '+partner+' uses; stay natural and in character.',dj,nowLine].filter(Boolean).join('\n\n'); }
